    ...
    <section class="ica-sec sec-partners" style="background-color:<?php echo $cores_gi['fundo']  ?>">
        <div class="ica-wrapper">
            ...
            $imagem_gi = get_sub_field('imagem_gi');?>
                <?php foreach ($imagem_gi as $igi) { ?>
                <div class="item-media">
                    <img src="<?php echo $igi['imagem']['url'] ?>" alt="logo de parceiro">
                </div>
                <?php }
            ?>
            </div>
            ...
            <div class="sec-content">
                <div class="sec-item">
                    <div class="item-media">
                        ...
                        <div class="seta"><img
                                src="<?php echo get_template_directory_uri() . '/images/seta-baixo.png' ?>" alt="seta">
                        </div>
                ...
                <div class="sec-item item-double">
                    <div class="item-media">
                        <img src="<?php echo the_sub_field('icone_c2'); ?>" alt="Avalie">
                        <h3><?php echo the_sub_field('titulo_c2'); ?></h3>
                        <p>
                            <?php echo the_sub_field('descricao_c2'); ?>
                        </p>
                        <div class="seta"><img
                                src="<?php echo get_template_directory_uri() . '/images/seta-baixo.png' ?>" alt="seta">
                        </div>
                        <div class="item-double_container">
                            <div class="media-aside">
                                <h3><?php echo the_sub_field('titulo_lista_1'); ?></h3>
                            ...
                            <div class="media-aside">
                                <h3><?php echo the_sub_field('titulo_lista_2'); ?></h3>
                                <ul class="whatwedo-list">
                ...
                <div class="sec-item ">
                    <div class="item-media">
                        <img src="<?php echo the_sub_field('icone_c3'); ?>" alt="Realize">
                        <h3><?php echo the_sub_field('titulo_c3'); ?></h3>
                        <p>
                            <?php echo the_sub_field('descricao_c3'); ?>
                        </p>
                        <div class="seta">
