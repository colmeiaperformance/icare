  ...
  <div class="ica-wrapper">
    <div class="sec-content">
      ...
      <div class="content-complement">
        <p class="ica-the the-gray-222"><?php echo get_sub_field('texto_secundario_tl') ?></p>
      </div>
      <?php endif; ?>
    </div>
  </div>
    ...
    <div class="sec-content">
      <div class="sec-item">
        <div class="item-media">
          ...
          <?php endif; ?>
          <div class="seta"><img src="<?php echo get_template_directory_uri() . '/images/seta-baixo.png' ?>" alt="">
          </div>
      ...
      <div class="sec-item item-double">
        <div class="item-media">
          ...
          <div class="seta"><img src="<?php echo get_template_directory_uri() . '/images/seta-baixo.png' ?>" alt="seta">
          </div>
