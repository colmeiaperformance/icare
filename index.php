			...
			<div class="ica-wrapper">
				...
				<dl class="footer-item">
					...
					<dd>
                        ...
                        <a href="#">  <img src="<?php echo get_template_directory_uri() . '/images/tel-icon.png' ?>" alt="tel-icon">+55 (11) 3515-6135</a>
                    </dd>
					<dd>
                    
                        <a href="#"><img src="<?php echo get_template_directory_uri() . '/images/email-icon.png' ?>" alt="email-icon">contato-brasil@i-care-consult.com</a>
                    </dd>
                    <div class="footer-icons" >
                        <a href="#"><img src="<?php echo get_template_directory_uri() . '/images/linkedin-icon.png' ?>" alt="linkedin-icon"></a>
                        <a href="#"><img src="<?php echo get_template_directory_uri() . '/images/twitter-icon.png' ?>" alt="twitter-icon"></a>
